...
describe("Quick Sort", () => {
  ...
  it("Can successfully sort a Reverse-sorted array", () => {
    expect(quickSort([20,18,12,8,5,-2])).toEqual([-2, 5, 8, 12, 18, 20]);
  });

  it("Can successfully sort a Few uniques array", () => {
    expect(quickSort([5,12,7,5,5,7])).toEqual([5, 5, 5, 7, 7, 12]);
  });

  it("Can successfully sort a Nearly-sorted array", () => {
    expect(quickSort([2,3,5,7,13,11])).toEqual([2,3,5,7,11,13]);
  });
