...
let findShortest = (data) => {
  ...
  let shortest = '';
  let myArray = data.map(obj => obj.height).sort((a, b) => a - b);
  data.forEach(value => {
    if (myArray[0] === value.height) {
